This is the readme file for implementing filter and bakery locks in Java. For analysis and conclusion of results read here: http://furkankamaci.com/implementing-filter-and-bakery-locks-in-java/
